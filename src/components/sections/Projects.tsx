...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-24 px-6 sm:px-12 bg-black text-white relative z-20">
            ...
            >
              {filteredProjects.map((project, idx) => (
                <motion.div
                  ...
                  className="group relative rounded-3xl bg-neutral-900/90 border border-neutral-800 p-6 sm:p-8 hover:bg-neutral-900 hover:border-neutral-600 hover:shadow-2xl transition-all duration-300 flex flex-col justify-between cursor-pointer overflow-hidden text-white"
                  data-cursor="EXPLORE"
                >
